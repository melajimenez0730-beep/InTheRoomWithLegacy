    ...
    <>
      <button 
        ...
        className={buttonVariants({
          variant: "outline",
          size: "lg",
          class: `border-primary text-primary hover:bg-primary/10 font-medium w-full block justify-center text-center text-[15px] sm:text-sm max-w-full my-1 mx-0 overflow-hidden ${className}`
        })}
      >
